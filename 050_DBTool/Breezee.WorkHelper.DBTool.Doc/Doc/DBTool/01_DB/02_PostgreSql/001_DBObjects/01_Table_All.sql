...
COL_DEFAULT_ID character varying(36) NOT NULL ,/*列默认配置ID*/
COLUMN_NAME character varying(50),/*列编码*/
DEFAULT_MYSQL character varying(100),/*MySql默认值*/
DEFAULT_POSTGRESQL character varying(100),/*PostgreSql默认值*/
DEFAULT_ORACLE character varying(100),/*Oracle默认值*/
DEFAULT_SQLSERVER character varying(100),/*SqlServer默认值*/
DEFAULT_SQLITE character varying(100),/*SQLite默认值*/
IS_USED_ADD character varying(2),/*是否新增使用*/
IS_USED_UPDATE character varying(2),/*是否修改使用*/
IS_CONDITION_QUERY character varying(2),/*是否查询条件*/
IS_CONDITION_UPDATE character varying(2),/*是否更新条件*/
IS_CONDITION_DELETE character varying(2),/*是否删除条件*/
SORT_ID int ,/*排序ID*/
REMARK character varying(200),/*备注*/
CREATE_TIME date  NOT NULL  DEFAULT now() ,/*创建时间*/
CREATOR_ID character varying(36) NOT NULL ,/*创建人ID*/
