    ...
    public partial class FrmDBTDataStandardSet : BaseForm
    {
        ...
        private void SetTag()
        {
            ...
            fdc.AddColumn(
                ...
                new FlexGridColumn.Builder().Name(DataStandardStr.OracleDataTypeFull).Caption("全类型(MySql)").Type(DataGridViewColumnTypeEnum.TextBox).Align(DataGridViewContentAlignment.MiddleLeft).Width(100).Edit(false).Visible().Build(),
