...
```
declare
 o_Return_Code   varchar2(50);
 o_Error_message varchar2(1000);
 o_Sqlerrm       varchar2(1000);
begin
 for DR in (SELECT '1' AS "ROWNO", 'Q011D407Q4DBL04' AS PRD_CODE
              FROM DUAL
            UNION ALL
            SELECT '2' AS "ROWNO", 'Q011W615G1T7001' AS PRD_CODE
              FROM DUAL
            UNION ALL
            SELECT '3', 'Q011W61861P7S00'
              FROM DUAL
           
            ) LOOP
   PKG_JF_MBOM_QDPrdcolor.P_PrdColor_Main(i_Pmid          => DR.PRD_CODE,
