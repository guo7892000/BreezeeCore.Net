...
namespace Breezee.WorkHelper.DBTool.Entity
{
    ...
    /// 数据类型标准（日期）
    /// </summary>
    public class DataStandardTypeConfigDate
    {
        public MoreKeyValueGroupConfig MoreXmlConfig { get; set; }
        public DataStandardTypeConfigDate()
        {
            ...
            entity.FileName = Path.Combine(GlobalContext.AppEntryAssemblyPath, DBTGlobalValue.Cfg.DBTDataTypeConfigDate);
