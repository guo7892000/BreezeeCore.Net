...
namespace Breezee.WorkHelper.DBTool.Entity
{
    ...
    /// 数据类型标准（小数）
    /// </summary>
    public class DataStandardTypeConfigDecimal
    {
        public MoreKeyValueGroupConfig MoreXmlConfig { get; set; }
        public DataStandardTypeConfigDecimal()
        {
            ...
            entity.FileName = Path.Combine(GlobalContext.AppEntryAssemblyPath, DBTGlobalValue.Cfg.DBTDataTypeConfigDecimal); 
