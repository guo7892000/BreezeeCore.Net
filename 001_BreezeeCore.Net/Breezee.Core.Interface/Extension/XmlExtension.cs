...
namespace Breezee.Core.Interface
{
    ...
    {
        #region 获取XmlNode属性值
        public static string GetAttributeValue(this XmlNode xmlNode, string strAttribute)
        {
            string strReturn = "";
            if (!(xmlNode == null))
            {//获取节点的属性，并循环取出需要的属性值
        ...
        public static string GetOrDefaultAttrValue(this XmlNode xn, string attrName,string defaultValue = "")
        {
            XmlAttribute attr = xn.Attributes[attrName];
            if (attr == null) return defaultValue;
            if(string.IsNullOrWhiteSpace(attr.Value) && !string.IsNullOrWhiteSpace(defaultValue))
            {
                return defaultValue;
            }
            return attr.Value;
        ...
        public static bool TryGetAttrValue(this XmlNode xn, string attrName,out string sReturn, string defaultValue = "")
        {
            sReturn = "";
            XmlAttribute attr = xn.Attributes[attrName];
            ...
            return !string.IsNullOrWhiteSpace(sReturn);
        }
