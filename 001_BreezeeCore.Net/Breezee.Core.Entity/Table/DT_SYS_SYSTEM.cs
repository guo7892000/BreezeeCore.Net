...
{
	[Serializable]
	public partial class DT_SYS_SYSTEM : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_SYSTEM"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_SYSTEM();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_SYSTEM";} }
		//自动生成字段
		 ...
		 public static string SYS_CODE_FULL = "SYS_CODE_FULL";
		 public DbField EF_SYS_CODE_FULL = new DbField().DBColName("SYS_CODE_FULL").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string SYS_CODE_SHORT = "SYS_CODE_SHORT";
		 public DbField EF_SYS_CODE_SHORT = new DbField().DBColName("SYS_CODE_SHORT").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string SYS_DESC = "SYS_DESC";
		 public DbField EF_SYS_DESC = new DbField().DBColName("SYS_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string SYS_NAME_FULL = "SYS_NAME_FULL";
		 public DbField EF_SYS_NAME_FULL = new DbField().DBColName("SYS_NAME_FULL").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string SYS_NAME_SHORT = "SYS_NAME_SHORT";
		 public DbField EF_SYS_NAME_SHORT = new DbField().DBColName("SYS_NAME_SHORT").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_SYS_CODE_FULL,EF_SYS_CODE_SHORT,EF_SYS_DESC,EF_SYS_ID,EF_SYS_NAME_FULL,EF_SYS_NAME_SHORT,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","SYS_CODE_FULL","SYS_CODE_SHORT","SYS_DESC","SYS_ID","SYS_NAME_FULL","SYS_NAME_SHORT","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
