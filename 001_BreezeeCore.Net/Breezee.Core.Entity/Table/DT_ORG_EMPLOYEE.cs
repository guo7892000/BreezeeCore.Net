...
{
	[Serializable]
	public partial class DT_ORG_EMPLOYEE : DbEntity
	{

		//自动生成表名
		public static string TName = "ORG_EMPLOYEE"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_ORG_EMPLOYEE();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "ORG_EMPLOYEE";} }
		//自动生成字段
		 public static string COME_DATE = "COME_DATE";
		 public DbField EF_COME_DATE = new DbField().DBColName("COME_DATE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string COME_DESC = "COME_DESC";
		 public DbField EF_COME_DESC = new DbField().DBColName("COME_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_DEPT_ID = new DbField().DBColName("DEPT_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string EMP_CODE = "EMP_CODE";
		 public DbField EF_EMP_CODE = new DbField().DBColName("EMP_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_EMP_NAME = new DbField().DBColName("EMP_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string EMP_NAME_EN = "EMP_NAME_EN";
		 public DbField EF_EMP_NAME_EN = new DbField().DBColName("EMP_NAME_EN").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_LEAVE_DATE = new DbField().DBColName("LEAVE_DATE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string LEAVE_RESON = "LEAVE_RESON";
		 public DbField EF_LEAVE_RESON = new DbField().DBColName("LEAVE_RESON").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string WORK_NO = "WORK_NO";
		 public DbField EF_WORK_NO = new DbField().DBColName("WORK_NO").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string WORK_STATUS = "WORK_STATUS";
		 public DbField EF_WORK_STATUS = new DbField().DBColName("WORK_STATUS").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_COME_DATE,EF_COME_DESC,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DEPT_ID,EF_EMP_CODE,EF_EMP_ID,EF_EMP_NAME,EF_EMP_NAME_EN,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_LEAVE_DATE,EF_LEAVE_RESON,EF_LEVEL_ID,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_PERSON_ID,EF_POSITION_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID,EF_WORK_NO,EF_WORK_STATUS });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "COME_DATE","COME_DESC","CREATE_TIME","CREATOR","CREATOR_ID","DEPT_ID","EMP_CODE","EMP_ID","EMP_NAME","EMP_NAME_EN","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","LEAVE_DATE","LEAVE_RESON","LEVEL_ID","MODIFIER","MODIFIER_ID","ORG_ID","PERSON_ID","POSITION_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID","WORK_NO","WORK_STATUS" });
				 return DbColumn;
			}
		 }
	}
