...
{
	[Serializable]
	public partial class DT_SYS_DELETE_DATA_JUDGE : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_DELETE_DATA_JUDGE"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_DELETE_DATA_JUDGE();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_DELETE_DATA_JUDGE";} }
		//自动生成字段
		 ...
		 public static string DELETE_DATA_PK_COLUNM_CODE = "DELETE_DATA_PK_COLUNM_CODE";
		 public DbField EF_DELETE_DATA_PK_COLUNM_CODE = new DbField().DBColName("DELETE_DATA_PK_COLUNM_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string DELETE_DATA_PK_COLUNM_NAME = "DELETE_DATA_PK_COLUNM_NAME";
		 public DbField EF_DELETE_DATA_PK_COLUNM_NAME = new DbField().DBColName("DELETE_DATA_PK_COLUNM_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string DELETE_DATA_TABLE_NAME = "DELETE_DATA_TABLE_NAME";
		 public DbField EF_DELETE_DATA_TABLE_NAME = new DbField().DBColName("DELETE_DATA_TABLE_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DELETE_DATA_JUDGE_ID,EF_DELETE_DATA_PK_COLUNM_CODE,EF_DELETE_DATA_PK_COLUNM_NAME,EF_DELETE_DATA_TABLE_CODE,EF_DELETE_DATA_TABLE_NAME,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","DELETE_DATA_JUDGE_ID","DELETE_DATA_PK_COLUNM_CODE","DELETE_DATA_PK_COLUNM_NAME","DELETE_DATA_TABLE_CODE","DELETE_DATA_TABLE_NAME","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
