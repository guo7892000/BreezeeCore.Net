...
{
	[Serializable]
	public partial class DT_SYS_DLL : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_DLL"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_DLL();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_DLL";} }
		//自动生成字段
		 ...
		 public static string DLL_DESC = "DLL_DESC";
		 public DbField EF_DLL_DESC = new DbField().DBColName("DLL_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string DLL_NAME_CN = "DLL_NAME_CN";
		 public DbField EF_DLL_NAME_CN = new DbField().DBColName("DLL_NAME_CN").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string DLL_TYPE = "DLL_TYPE";
		 public DbField EF_DLL_TYPE = new DbField().DBColName("DLL_TYPE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DLL_DESC,EF_DLL_ID,EF_DLL_NAME,EF_DLL_NAME_CN,EF_DLL_TYPE,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","DLL_DESC","DLL_ID","DLL_NAME","DLL_NAME_CN","DLL_TYPE","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
