...
{
	[Serializable]
	public partial class DT_SYS_REL_MENU_OBJECT : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_REL_MENU_OBJECT"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_REL_MENU_OBJECT();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_REL_MENU_OBJECT";} }
		//自动生成字段
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MENU_ID,EF_MODIFIER,EF_MODIFIER_ID,EF_OBJECT_ID,EF_OBJECT_TYPE,EF_ORG_ID,EF_REL_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MENU_ID","MODIFIER","MODIFIER_ID","OBJECT_ID","OBJECT_TYPE","ORG_ID","REL_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
