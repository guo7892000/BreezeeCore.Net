...
{
	[Serializable]
	public partial class DT_SYS_MSG_TEMPLET_PARA : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_MSG_TEMPLET_PARA"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_MSG_TEMPLET_PARA();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_MSG_TEMPLET_PARA";} }
		//自动生成字段
		 ...
		 public static string MSG_TEMPLET_PARA_CODE = "MSG_TEMPLET_PARA_CODE";
		 public DbField EF_MSG_TEMPLET_PARA_CODE = new DbField().DBColName("MSG_TEMPLET_PARA_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string MSG_TEMPLET_PARA_ID = "MSG_TEMPLET_PARA_ID";
		 public DbField EF_MSG_TEMPLET_PARA_ID = new DbField().DBColName("MSG_TEMPLET_PARA_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string MSG_TEMPLET_PARA_NAME = "MSG_TEMPLET_PARA_NAME";
		 public DbField EF_MSG_TEMPLET_PARA_NAME = new DbField().DBColName("MSG_TEMPLET_PARA_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string MSG_TEMPLET_PARA_RAMARK = "MSG_TEMPLET_PARA_RAMARK";
		 public DbField EF_MSG_TEMPLET_PARA_RAMARK = new DbField().DBColName("MSG_TEMPLET_PARA_RAMARK").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_EXTEND_1,EF_EXTEND_2,EF_EXTEND_3,EF_EXTEND_4,EF_EXTEND_5,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_MSG_TEMPLET_ID,EF_MSG_TEMPLET_PARA_CODE,EF_MSG_TEMPLET_PARA_ID,EF_MSG_TEMPLET_PARA_NAME,EF_MSG_TEMPLET_PARA_RAMARK,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","EXTEND_1","EXTEND_2","EXTEND_3","EXTEND_4","EXTEND_5","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","MSG_TEMPLET_ID","MSG_TEMPLET_PARA_CODE","MSG_TEMPLET_PARA_ID","MSG_TEMPLET_PARA_NAME","MSG_TEMPLET_PARA_RAMARK","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
