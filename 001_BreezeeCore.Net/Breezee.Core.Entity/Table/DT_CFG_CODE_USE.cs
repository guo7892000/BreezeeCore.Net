...
{
	[Serializable]
	public partial class DT_CFG_CODE_USE : DbEntity
	{

		//自动生成表名
		public static string TName = "CFG_CODE_USE"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_CFG_CODE_USE();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "CFG_CODE_USE";} }
		//自动生成字段
		 ...
		 public static string CODE_USE_ID = "CODE_USE_ID";
		 public DbField EF_CODE_USE_ID = new DbField().DBColName("CODE_USE_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_CURRENT_VALUE = new DbField().DBColName("CURRENT_VALUE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string DATE_FORMAT_VALUE = "DATE_FORMAT_VALUE";
		 public DbField EF_DATE_FORMAT_VALUE = new DbField().DBColName("DATE_FORMAT_VALUE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string REL_OBJECT_ID = "REL_OBJECT_ID";
		 public DbField EF_REL_OBJECT_ID = new DbField().DBColName("REL_OBJECT_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CODE_RULE_CODE,EF_CODE_USE_ID,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_CURRENT_VALUE,EF_DATE_FORMAT_VALUE,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REL_OBJECT_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CODE_RULE_CODE","CODE_USE_ID","CREATE_TIME","CREATOR","CREATOR_ID","CURRENT_VALUE","DATE_FORMAT_VALUE","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REL_OBJECT_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
