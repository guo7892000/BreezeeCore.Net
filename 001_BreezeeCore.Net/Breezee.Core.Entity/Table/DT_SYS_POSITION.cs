...
{
	[Serializable]
	public partial class DT_SYS_POSITION : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_POSITION"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_POSITION();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_POSITION";} }
		//自动生成字段
		 ...
		 public static string SYS_POSITION_CODE = "SYS_POSITION_CODE";
		 public DbField EF_SYS_POSITION_CODE = new DbField().DBColName("SYS_POSITION_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string SYS_POSITION_DESC = "SYS_POSITION_DESC";
		 public DbField EF_SYS_POSITION_DESC = new DbField().DBColName("SYS_POSITION_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string SYS_POSITION_ID = "SYS_POSITION_ID";
		 public DbField EF_SYS_POSITION_ID = new DbField().DBColName("SYS_POSITION_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string SYS_POSITION_NAME = "SYS_POSITION_NAME";
		 public DbField EF_SYS_POSITION_NAME = new DbField().DBColName("SYS_POSITION_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_SYS_ID,EF_SYS_POSITION_CODE,EF_SYS_POSITION_DESC,EF_SYS_POSITION_ID,EF_SYS_POSITION_NAME,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","SYS_ID","SYS_POSITION_CODE","SYS_POSITION_DESC","SYS_POSITION_ID","SYS_POSITION_NAME","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
