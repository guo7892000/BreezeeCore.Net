...
{
	[Serializable]
	public partial class DT_ORG_ORGANIZATION : DbEntity
	{

		//自动生成表名
		public static string TName = "ORG_ORGANIZATION"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_ORG_ORGANIZATION();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "ORG_ORGANIZATION";} }
		//自动生成字段
		 ...
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "BELONG_ORG_ID","CREATE_TIME","CREATOR","CREATOR_ID","FORM_CODE_SHORT","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","OBJECT_ID","ORG_CODE_FULL","ORG_CODE_SHORT","ORG_ID","ORG_NAME_FULL","ORG_NAME_SHORT","ORG_TYPE","PARENT_ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
