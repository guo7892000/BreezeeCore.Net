...
{
	[Serializable]
	public partial class DT_V_SYS_AND_MENU : DbEntity
	{

		//自动生成表名
		public static string TName = "V_SYS_AND_MENU"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_V_SYS_AND_MENU();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "V_SYS_AND_MENU";} }
		//自动生成字段
