...
{
	[Serializable]
	public partial class DT_SYS_DELETE_DATA_JUDGE_D : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_DELETE_DATA_JUDGE_D"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_DELETE_DATA_JUDGE_D();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_DELETE_DATA_JUDGE_D";} }
		//自动生成字段
		 ...
		 public static string DELETE_DATA_JUDGE_D_ID = "DELETE_DATA_JUDGE_D_ID";
		 public DbField EF_DELETE_DATA_JUDGE_D_ID = new DbField().DBColName("DELETE_DATA_JUDGE_D_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string DELETE_DATA_JUDGE_ID = "DELETE_DATA_JUDGE_ID";
		 public DbField EF_DELETE_DATA_JUDGE_ID = new DbField().DBColName("DELETE_DATA_JUDGE_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string DELETE_DATA_TABLE_CODE = "DELETE_DATA_TABLE_CODE";
		 public DbField EF_DELETE_DATA_TABLE_CODE = new DbField().DBColName("DELETE_DATA_TABLE_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string JUDGE_TABLE_CODE = "JUDGE_TABLE_CODE";
		 public DbField EF_JUDGE_TABLE_CODE = new DbField().DBColName("JUDGE_TABLE_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string JUDGE_TABLE_FK_COLUMN_CODE = "JUDGE_TABLE_FK_COLUMN_CODE";
		 public DbField EF_JUDGE_TABLE_FK_COLUMN_CODE = new DbField().DBColName("JUDGE_TABLE_FK_COLUMN_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string JUDGE_TABLE_FK_COLUMN_NAME = "JUDGE_TABLE_FK_COLUMN_NAME";
		 public DbField EF_JUDGE_TABLE_FK_COLUMN_NAME = new DbField().DBColName("JUDGE_TABLE_FK_COLUMN_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string JUDGE_TABLE_NAME = "JUDGE_TABLE_NAME";
		 public DbField EF_JUDGE_TABLE_NAME = new DbField().DBColName("JUDGE_TABLE_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DELETE_DATA_JUDGE_D_ID,EF_DELETE_DATA_JUDGE_ID,EF_DELETE_DATA_TABLE_CODE,EF_IS_ENABLED,EF_IS_SYSTEM,EF_JUDGE_TABLE_CODE,EF_JUDGE_TABLE_FK_COLUMN_CODE,EF_JUDGE_TABLE_FK_COLUMN_NAME,EF_JUDGE_TABLE_NAME,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","DELETE_DATA_JUDGE_D_ID","DELETE_DATA_JUDGE_ID","DELETE_DATA_TABLE_CODE","IS_ENABLED","IS_SYSTEM","JUDGE_TABLE_CODE","JUDGE_TABLE_FK_COLUMN_CODE","JUDGE_TABLE_FK_COLUMN_NAME","JUDGE_TABLE_NAME","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
