...
{
	[Serializable]
	public partial class DT_ORG_REL_EMPLOYEE_POSITION : DbEntity
	{

		//自动生成表名
		public static string TName = "ORG_REL_EMPLOYEE_POSITION"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_ORG_REL_EMPLOYEE_POSITION();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "ORG_REL_EMPLOYEE_POSITION";} }
		//自动生成字段
		 ...
		 public static string FIRST_POSITION_FLAG = "FIRST_POSITION_FLAG";
		 public DbField EF_FIRST_POSITION_FLAG = new DbField().DBColName("FIRST_POSITION_FLAG").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_EMP_ID,EF_FIRST_POSITION_FLAG,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_LEVEL_ID,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_POSITION_ID,EF_REL_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","EMP_ID","FIRST_POSITION_FLAG","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","LEVEL_ID","MODIFIER","MODIFIER_ID","ORG_ID","POSITION_ID","REL_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
