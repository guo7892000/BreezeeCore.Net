...
{
	[Serializable]
	public partial class DT_SYS_MSG_SEND : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_MSG_SEND"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_MSG_SEND();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_MSG_SEND";} }
		//自动生成字段
		 ...
		 public static string DELIVER_TIMES = "DELIVER_TIMES";
		 public DbField EF_DELIVER_TIMES = new DbField().DBColName("DELIVER_TIMES").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string IS_SENDED = "IS_SENDED";
		 public DbField EF_IS_SENDED = new DbField().DBColName("IS_SENDED").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DELIVER_TIMES,EF_EXTEND_1,EF_EXTEND_2,EF_EXTEND_3,EF_EXTEND_4,EF_EXTEND_5,EF_IS_ENABLED,EF_IS_SENDED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_MSG_ID,EF_MSG_SEND_ID,EF_ORG_ID,EF_REMARK,EF_SEND_TIME,EF_SEND_TYPE,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","DELIVER_TIMES","EXTEND_1","EXTEND_2","EXTEND_3","EXTEND_4","EXTEND_5","IS_ENABLED","IS_SENDED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","MSG_ID","MSG_SEND_ID","ORG_ID","REMARK","SEND_TIME","SEND_TYPE","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
