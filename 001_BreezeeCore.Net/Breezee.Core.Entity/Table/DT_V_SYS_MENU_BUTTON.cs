...
{
	[Serializable]
	public partial class DT_V_SYS_MENU_BUTTON : DbEntity
	{

		//自动生成表名
		public static string TName = "V_SYS_MENU_BUTTON"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_V_SYS_MENU_BUTTON();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "V_SYS_MENU_BUTTON";} }
		//自动生成字段
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DLL_ID,EF_DLL_NAME,EF_FORM_FULL_PATH,EF_FORM_ID,EF_FORM_TYPE,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MENU_ACTION,EF_MENU_CODE,EF_MENU_DESC,EF_MENU_FULL_PATH,EF_MENU_ICON,EF_MENU_ID,EF_MENU_NAME,EF_MENU_PARM,EF_MENU_TYPE,EF_MODIFIER,EF_MODIFIER_ID,EF_NOT_RIGHT_BUTTON_DISPLAY_TYPE,EF_ORG_ID,EF_PARENT_MENU_ID,EF_REMARK,EF_RIGHT_TYPE,EF_SORT_ID,EF_SYS_ID,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","DLL_ID","DLL_NAME","FORM_FULL_PATH","FORM_ID","FORM_TYPE","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MENU_ACTION","MENU_CODE","MENU_DESC","MENU_FULL_PATH","MENU_ICON","MENU_ID","MENU_NAME","MENU_PARM","MENU_TYPE","MODIFIER","MODIFIER_ID","NOT_RIGHT_BUTTON_DISPLAY_TYPE","ORG_ID","PARENT_MENU_ID","REMARK","RIGHT_TYPE","SORT_ID","SYS_ID","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
