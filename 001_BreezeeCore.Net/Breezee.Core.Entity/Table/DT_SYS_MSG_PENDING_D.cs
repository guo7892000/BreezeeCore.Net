...
{
	[Serializable]
	public partial class DT_SYS_MSG_PENDING_D : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_MSG_PENDING_D"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_MSG_PENDING_D();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_MSG_PENDING_D";} }
		//自动生成字段
		 ...
		 public static string PENDING_D_ID = "PENDING_D_ID";
		 public DbField EF_PENDING_D_ID = new DbField().DBColName("PENDING_D_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string REMIND_OBJECT_ID = "REMIND_OBJECT_ID";
		 public DbField EF_REMIND_OBJECT_ID = new DbField().DBColName("REMIND_OBJECT_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string REMIND_RELATE_TYPE = "REMIND_RELATE_TYPE";
		 public DbField EF_REMIND_RELATE_TYPE = new DbField().DBColName("REMIND_RELATE_TYPE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_EXTEND_1,EF_EXTEND_2,EF_EXTEND_3,EF_EXTEND_4,EF_EXTEND_5,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_PENDING_D_ID,EF_PENDING_ID,EF_REMARK,EF_REMIND_OBJECT_ID,EF_REMIND_RELATE_TYPE,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","EXTEND_1","EXTEND_2","EXTEND_3","EXTEND_4","EXTEND_5","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","PENDING_D_ID","PENDING_ID","REMARK","REMIND_OBJECT_ID","REMIND_RELATE_TYPE","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
