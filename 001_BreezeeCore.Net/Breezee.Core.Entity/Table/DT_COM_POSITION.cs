...
{
	[Serializable]
	public partial class DT_COM_POSITION : DbEntity
	{

		//自动生成表名
		public static string TName = "COM_POSITION"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_COM_POSITION();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "COM_POSITION";} }
		//自动生成字段
		 public static string COM_DEPT_ID = "COM_DEPT_ID";
		 public DbField EF_COM_DEPT_ID = new DbField().DBColName("COM_DEPT_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string COM_POSITION_CODE = "COM_POSITION_CODE";
		 public DbField EF_COM_POSITION_CODE = new DbField().DBColName("COM_POSITION_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string COM_POSITION_DESC = "COM_POSITION_DESC";
		 public DbField EF_COM_POSITION_DESC = new DbField().DBColName("COM_POSITION_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string COM_POSITION_NAME = "COM_POSITION_NAME";
		 public DbField EF_COM_POSITION_NAME = new DbField().DBColName("COM_POSITION_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_COM_DEPT_ID,EF_COM_POSITION_CODE,EF_COM_POSITION_DESC,EF_COM_POSITION_ID,EF_COM_POSITION_NAME,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "COM_DEPT_ID","COM_POSITION_CODE","COM_POSITION_DESC","COM_POSITION_ID","COM_POSITION_NAME","CREATE_TIME","CREATOR","CREATOR_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
