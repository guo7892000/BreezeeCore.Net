...
{
	[Serializable]
	public partial class DT_SYS_ROLE : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_ROLE"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_ROLE();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_ROLE";} }
		//自动生成字段
		 ...
		 public DbField EF_ROLE_CODE = new DbField().DBColName("ROLE_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string ROLE_DESC = "ROLE_DESC";
		 public DbField EF_ROLE_DESC = new DbField().DBColName("ROLE_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string ROLE_ID = "ROLE_ID";
		 public DbField EF_ROLE_ID = new DbField().DBColName("ROLE_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string ROLE_NAME = "ROLE_NAME";
		 public DbField EF_ROLE_NAME = new DbField().DBColName("ROLE_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string ROLE_TYPE = "ROLE_TYPE";
		 public DbField EF_ROLE_TYPE = new DbField().DBColName("ROLE_TYPE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_ROLE_CODE,EF_ROLE_DESC,EF_ROLE_ID,EF_ROLE_NAME,EF_ROLE_TYPE,EF_SORT_ID,EF_SYS_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","ROLE_CODE","ROLE_DESC","ROLE_ID","ROLE_NAME","ROLE_TYPE","SORT_ID","SYS_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
