...
{
	[Serializable]
	public partial class DT_ORG_DEPT : DbEntity
	{

		//自动生成表名
		public static string TName = "ORG_DEPT"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_ORG_DEPT();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "ORG_DEPT";} }
		//自动生成字段
		 ...
		 public static string DEPT_ADDR = "DEPT_ADDR";
		 public DbField EF_DEPT_ADDR = new DbField().DBColName("DEPT_ADDR").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_DEPT_DESC = new DbField().DBColName("DEPT_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_COM_DEPT_ID,EF_COMP_ID,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DEPT_ADDR,EF_DEPT_CODE,EF_DEPT_DESC,EF_DEPT_ID,EF_DEPT_NAME,EF_FAX_NO,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_OFFICE_PHONE,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "COM_DEPT_ID","COMP_ID","CREATE_TIME","CREATOR","CREATOR_ID","DEPT_ADDR","DEPT_CODE","DEPT_DESC","DEPT_ID","DEPT_NAME","FAX_NO","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","OFFICE_PHONE","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
