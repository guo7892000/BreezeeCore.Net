...
{
	[Serializable]
	public partial class DT_SYS_USER_GROUP : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_USER_GROUP"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_USER_GROUP();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_USER_GROUP";} }
		//自动生成字段
		 ...
		 public DbField EF_GROUP_CODE = new DbField().DBColName("GROUP_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_GROUP_NAME = new DbField().DBColName("GROUP_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_ACTIVE_TIME,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DISABLE_TIME,EF_GROUP_CODE,EF_GROUP_DESC,EF_GROUP_ID,EF_GROUP_NAME,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "ACTIVE_TIME","CREATE_TIME","CREATOR","CREATOR_ID","DISABLE_TIME","GROUP_CODE","GROUP_DESC","GROUP_ID","GROUP_NAME","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
