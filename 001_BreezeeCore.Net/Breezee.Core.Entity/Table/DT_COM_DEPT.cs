...
{
	[Serializable]
	public partial class DT_COM_DEPT : DbEntity
	{

		//自动生成表名
		public static string TName = "COM_DEPT"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_COM_DEPT();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "COM_DEPT";} }
		//自动生成字段
		 ...
		 public DbField EF_DEPT_CODE = new DbField().DBColName("DEPT_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string DEPT_NAME = "DEPT_NAME";
		 public DbField EF_DEPT_NAME = new DbField().DBColName("DEPT_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string ORG_TYPE_CODE = "ORG_TYPE_CODE";
		 public DbField EF_ORG_TYPE_CODE = new DbField().DBColName("ORG_TYPE_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_COM_DEPT_ID,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DEPT_CODE,EF_DEPT_NAME,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_ORG_TYPE_CODE,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "COM_DEPT_ID","CREATE_TIME","CREATOR","CREATOR_ID","DEPT_CODE","DEPT_NAME","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","ORG_TYPE_CODE","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
