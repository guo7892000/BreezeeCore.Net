...
{
	[Serializable]
	public partial class DT_SYS_MSG_DB_RECEIVER_GROUP : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_MSG_DB_RECEIVER_GROUP"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_MSG_DB_RECEIVER_GROUP();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_MSG_DB_RECEIVER_GROUP";} }
		//自动生成字段
		 ...
		 public static string RECEIVER_GROUP_CODE = "RECEIVER_GROUP_CODE";
		 public DbField EF_RECEIVER_GROUP_CODE = new DbField().DBColName("RECEIVER_GROUP_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string RECEIVER_GROUP_NAME = "RECEIVER_GROUP_NAME";
		 public DbField EF_RECEIVER_GROUP_NAME = new DbField().DBColName("RECEIVER_GROUP_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string RECEIVER_GROUP_REMARK = "RECEIVER_GROUP_REMARK";
		 public DbField EF_RECEIVER_GROUP_REMARK = new DbField().DBColName("RECEIVER_GROUP_REMARK").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_BELONG_MODULE_CODE,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_EXTEND_1,EF_EXTEND_2,EF_EXTEND_3,EF_EXTEND_4,EF_EXTEND_5,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_RECEIVER_GROUP_CODE,EF_RECEIVER_GROUP_ID,EF_RECEIVER_GROUP_NAME,EF_RECEIVER_GROUP_REMARK,EF_REMARK,EF_SEND_TYPE,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "BELONG_MODULE_CODE","CREATE_TIME","CREATOR","CREATOR_ID","EXTEND_1","EXTEND_2","EXTEND_3","EXTEND_4","EXTEND_5","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","RECEIVER_GROUP_CODE","RECEIVER_GROUP_ID","RECEIVER_GROUP_NAME","RECEIVER_GROUP_REMARK","REMARK","SEND_TYPE","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
