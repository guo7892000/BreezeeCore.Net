...
{
	[Serializable]
	public partial class DT_SYS_MSG_TEMPLET : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_MSG_TEMPLET"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_MSG_TEMPLET();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_MSG_TEMPLET";} }
		//自动生成字段
		 ...
		 public static string CONTENT_MODULE = "CONTENT_MODULE";
		 public DbField EF_CONTENT_MODULE = new DbField().DBColName("CONTENT_MODULE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string CONTENT_WRITE_RAMARK = "CONTENT_WRITE_RAMARK";
		 public DbField EF_CONTENT_WRITE_RAMARK = new DbField().DBColName("CONTENT_WRITE_RAMARK").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string MSG_TEMPLET_CODE = "MSG_TEMPLET_CODE";
		 public DbField EF_MSG_TEMPLET_CODE = new DbField().DBColName("MSG_TEMPLET_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string MSG_TEMPLET_ID = "MSG_TEMPLET_ID";
		 public DbField EF_MSG_TEMPLET_ID = new DbField().DBColName("MSG_TEMPLET_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string MSG_TEMPLET_NAME = "MSG_TEMPLET_NAME";
		 public DbField EF_MSG_TEMPLET_NAME = new DbField().DBColName("MSG_TEMPLET_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string MSG_TEMPLET_TYPE = "MSG_TEMPLET_TYPE";
		 public DbField EF_MSG_TEMPLET_TYPE = new DbField().DBColName("MSG_TEMPLET_TYPE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string PARA_SPLIT_STRING = "PARA_SPLIT_STRING";
		 public DbField EF_PARA_SPLIT_STRING = new DbField().DBColName("PARA_SPLIT_STRING").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string TITLE_MODULE = "TITLE_MODULE";
		 public DbField EF_TITLE_MODULE = new DbField().DBColName("TITLE_MODULE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_BELONG_MODULE_CODE,EF_CONTENT_MODULE,EF_CONTENT_WRITE_RAMARK,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_EXTEND_1,EF_EXTEND_2,EF_EXTEND_3,EF_EXTEND_4,EF_EXTEND_5,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_MSG_TEMPLET_CODE,EF_MSG_TEMPLET_ID,EF_MSG_TEMPLET_NAME,EF_MSG_TEMPLET_TYPE,EF_ORG_ID,EF_PARA_SPLIT_STRING,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_TITLE_MODULE,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "BELONG_MODULE_CODE","CONTENT_MODULE","CONTENT_WRITE_RAMARK","CREATE_TIME","CREATOR","CREATOR_ID","EXTEND_1","EXTEND_2","EXTEND_3","EXTEND_4","EXTEND_5","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","MSG_TEMPLET_CODE","MSG_TEMPLET_ID","MSG_TEMPLET_NAME","MSG_TEMPLET_TYPE","ORG_ID","PARA_SPLIT_STRING","REMARK","SORT_ID","TFLAG","TITLE_MODULE","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
