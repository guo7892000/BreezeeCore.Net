...
{
	[Serializable]
	public partial class DT_SYS_SYSTEM_GLOBAL_CONFIG : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_SYSTEM_GLOBAL_CONFIG"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_SYSTEM_GLOBAL_CONFIG();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_SYSTEM_GLOBAL_CONFIG";} }
		//自动生成字段
		 ...
		 public static string DB_ENVIRONMENT_TYPE = "DB_ENVIRONMENT_TYPE";
		 public DbField EF_DB_ENVIRONMENT_TYPE = new DbField().DBColName("DB_ENVIRONMENT_TYPE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string GLOBAL_CONFIG_ID = "GLOBAL_CONFIG_ID";
		 public DbField EF_GLOBAL_CONFIG_ID = new DbField().DBColName("GLOBAL_CONFIG_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string IS_LOGIN_USE_VERIFICATION = "IS_LOGIN_USE_VERIFICATION";
		 public DbField EF_IS_LOGIN_USE_VERIFICATION = new DbField().DBColName("IS_LOGIN_USE_VERIFICATION").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DB_ENVIRONMENT_TYPE,EF_GLOBAL_CONFIG_ID,EF_IS_ENABLED,EF_IS_LOGIN_USE_VERIFICATION,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","DB_ENVIRONMENT_TYPE","GLOBAL_CONFIG_ID","IS_ENABLED","IS_LOGIN_USE_VERIFICATION","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
