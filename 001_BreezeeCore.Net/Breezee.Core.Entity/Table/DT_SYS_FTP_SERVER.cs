...
{
	[Serializable]
	public partial class DT_SYS_FTP_SERVER : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_FTP_SERVER"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_FTP_SERVER();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_FTP_SERVER";} }
		//自动生成字段
		 ...
		 public DbField EF_DOWNLOAD_PATH = new DbField().DBColName("DOWNLOAD_PATH").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string FTP_SERVER_CODE = "FTP_SERVER_CODE";
		 public DbField EF_FTP_SERVER_CODE = new DbField().DBColName("FTP_SERVER_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string FTP_SERVER_ID = "FTP_SERVER_ID";
		 public DbField EF_FTP_SERVER_ID = new DbField().DBColName("FTP_SERVER_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string FTP_SERVER_NAME = "FTP_SERVER_NAME";
		 public DbField EF_FTP_SERVER_NAME = new DbField().DBColName("FTP_SERVER_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string IP_ADDR = "IP_ADDR";
		 public DbField EF_IP_ADDR = new DbField().DBColName("IP_ADDR").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string IS_DEFAULT = "IS_DEFAULT";
		 public DbField EF_IS_DEFAULT = new DbField().DBColName("IS_DEFAULT").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_PORT_NUM = new DbField().DBColName("PORT_NUM").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_ROOT_PATH = new DbField().DBColName("ROOT_PATH").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_UPLOAD_PATH = new DbField().DBColName("UPLOAD_PATH").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DOWNLOAD_PATH,EF_FTP_SERVER_CODE,EF_FTP_SERVER_ID,EF_FTP_SERVER_NAME,EF_IP_ADDR,EF_IS_DEFAULT,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_PORT_NUM,EF_REMARK,EF_ROOT_PATH,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID,EF_UPLOAD_PATH,EF_USER_NAME,EF_USER_PASSWORD });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","DOWNLOAD_PATH","FTP_SERVER_CODE","FTP_SERVER_ID","FTP_SERVER_NAME","IP_ADDR","IS_DEFAULT","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","PORT_NUM","REMARK","ROOT_PATH","SORT_ID","TFLAG","UPDATE_CONTROL_ID","UPLOAD_PATH","USER_NAME","USER_PASSWORD" });
				 return DbColumn;
			}
		 }
	}
