...
{
	[Serializable]
	public partial class DT_V_SYS_MENU_COMMON_BUTTON : DbEntity
	{

		//自动生成表名
		public static string TName = "V_SYS_MENU_COMMON_BUTTON"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_V_SYS_MENU_COMMON_BUTTON();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "V_SYS_MENU_COMMON_BUTTON";} }
		//自动生成字段
