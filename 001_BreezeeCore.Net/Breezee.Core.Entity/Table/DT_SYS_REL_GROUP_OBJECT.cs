...
{
	[Serializable]
	public partial class DT_SYS_REL_GROUP_OBJECT : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_REL_GROUP_OBJECT"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_REL_GROUP_OBJECT();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_REL_GROUP_OBJECT";} }
		//自动生成字段
		 ...
		 public DbField EF_OBJECT_TYPE = new DbField().DBColName("OBJECT_TYPE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string REL_GROUP_ID = "REL_GROUP_ID";
		 public DbField EF_REL_GROUP_ID = new DbField().DBColName("REL_GROUP_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_GROUP_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_OBJECT_ID,EF_OBJECT_TYPE,EF_ORG_ID,EF_REL_GROUP_ID,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","GROUP_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","OBJECT_ID","OBJECT_TYPE","ORG_ID","REL_GROUP_ID","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
