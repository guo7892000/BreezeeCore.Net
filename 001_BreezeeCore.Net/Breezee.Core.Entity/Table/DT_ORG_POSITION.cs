...
{
	[Serializable]
	public partial class DT_ORG_POSITION : DbEntity
	{

		//自动生成表名
		public static string TName = "ORG_POSITION"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_ORG_POSITION();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "ORG_POSITION";} }
		//自动生成字段
		 ...
		 public static string POSITION_CODE = "POSITION_CODE";
		 public DbField EF_POSITION_CODE = new DbField().DBColName("POSITION_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string POSITION_DESC = "POSITION_DESC";
		 public DbField EF_POSITION_DESC = new DbField().DBColName("POSITION_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_POSITION_NAME = new DbField().DBColName("POSITION_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_COM_POSITION_ID,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_DEPT_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_POSITION_CODE,EF_POSITION_DESC,EF_POSITION_ID,EF_POSITION_NAME,EF_REMARK,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "COM_POSITION_ID","CREATE_TIME","CREATOR","CREATOR_ID","DEPT_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","POSITION_CODE","POSITION_DESC","POSITION_ID","POSITION_NAME","REMARK","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
