...
{
	[Serializable]
	public partial class DT_SYS_MSG_AUTO_SEND_CONFIG_D : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_MSG_AUTO_SEND_CONFIG_D"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_MSG_AUTO_SEND_CONFIG_D();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_MSG_AUTO_SEND_CONFIG_D";} }
		//自动生成字段
		 ...
		 public static string SEND_CONFIG_D_ID = "SEND_CONFIG_D_ID";
		 public DbField EF_SEND_CONFIG_D_ID = new DbField().DBColName("SEND_CONFIG_D_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_EMAIL,EF_EMP_ID,EF_EMP_NAME,EF_EMP_PHONE,EF_EXTEND_1,EF_EXTEND_2,EF_EXTEND_3,EF_EXTEND_4,EF_EXTEND_5,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_SEND_CONFIG_D_ID,EF_SEND_CONFIG_ID,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "CREATE_TIME","CREATOR","CREATOR_ID","EMAIL","EMP_ID","EMP_NAME","EMP_PHONE","EXTEND_1","EXTEND_2","EXTEND_3","EXTEND_4","EXTEND_5","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","SEND_CONFIG_D_ID","SEND_CONFIG_ID","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
