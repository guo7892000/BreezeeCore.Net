...
{
	[Serializable]
	public partial class DT_SYS_BUTTON : DbEntity
	{

		//自动生成表名
		public static string TName = "SYS_BUTTON"; ////本身实例
		public static DbEntity NewEntity(){ return new DT_SYS_BUTTON();} ////本身实例
		 public override DbObjectType EntType {  get {return DbObjectType.Table;} }
		 public override string DBTableName {  get {return "SYS_BUTTON";} }
		//自动生成字段
		 public static string BUTTON_CODE = "BUTTON_CODE";
		 public DbField EF_BUTTON_CODE = new DbField().DBColName("BUTTON_CODE").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string BUTTON_DESC = "BUTTON_DESC";
		 public DbField EF_BUTTON_DESC = new DbField().DBColName("BUTTON_DESC").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public DbField EF_BUTTON_NAME = new DbField().DBColName("BUTTON_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);

		 public static string COM_BUTTON_ID = "COM_BUTTON_ID";
		 public DbField EF_COM_BUTTON_ID = new DbField().DBColName("COM_BUTTON_ID").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public static string RIGHT_CONTROL_DISPLAY_NAME = "RIGHT_CONTROL_DISPLAY_NAME";
		 public DbField EF_RIGHT_CONTROL_DISPLAY_NAME = new DbField().DBColName("RIGHT_CONTROL_DISPLAY_NAME").DBColType("VARCHAR").DBTypeSize("VARCHAR(36)").DBScale(-1).Nullable(true).PK(false).DBLen(36).FieldName("").FieldType(EntityFieldType.DbColumn).UpdateControl(false);
		 ...
		 public override List<DbField> DbColumnList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new DbField[] { EF_BUTTON_CODE,EF_BUTTON_DESC,EF_BUTTON_ID,EF_BUTTON_NAME,EF_COM_BUTTON_ID,EF_CREATE_TIME,EF_CREATOR,EF_CREATOR_ID,EF_FORM_ID,EF_IS_ENABLED,EF_IS_SYSTEM,EF_LAST_UPDATED_TIME,EF_MODIFIER,EF_MODIFIER_ID,EF_ORG_ID,EF_REMARK,EF_RIGHT_CONTROL_DISPLAY_NAME,EF_SORT_ID,EF_TFLAG,EF_UPDATE_CONTROL_ID });
				 return DbColumn;
			}
		 }
		 public override List<string> ColumnStringList
		 {
			get
			{
				 ...
				 DbColumn.AddRange(new string[] { "BUTTON_CODE","BUTTON_DESC","BUTTON_ID","BUTTON_NAME","COM_BUTTON_ID","CREATE_TIME","CREATOR","CREATOR_ID","FORM_ID","IS_ENABLED","IS_SYSTEM","LAST_UPDATED_TIME","MODIFIER","MODIFIER_ID","ORG_ID","REMARK","RIGHT_CONTROL_DISPLAY_NAME","SORT_ID","TFLAG","UPDATE_CONTROL_ID" });
				 return DbColumn;
			}
		 }
	}
